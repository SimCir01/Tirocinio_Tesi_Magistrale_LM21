...
constraint modify motion_generator  &
   motion_name = .robot_arm.motor_1  &
   function = "step(time,0,0d,1,-40d)+step(time,2,0d,3,20d)+step(time,3,0d,4,-20d)+step(time,4.1,0d,5,20d)+step(time,6,0d,7,-40d)"
!
constraint modify motion_generator  &
   motion_name = .robot_arm.motor_4  &
...
constraint modify motion_generator  &
   motion_name = .robot_arm.motor_2  &
   function = "step(time,0,0d,1,-110d)+step(time,2,0d,3,40d)+step(time,3,0d,4,-40d)+step(time,4.1,0d,5,40d)+step(time,6,0d,7,10d)"
!
constraint modify motion_generator  &
   motion_name = .robot_arm.motor_3  &
   function = "step(time,0,0d,1,60d)+step(time,2,0d,3,-60d)+step(time,3,0d,4,60d)+step(time,4.1,0d,5,-60d)"
!
